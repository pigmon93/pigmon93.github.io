...
**CERN, 실리콘에 새긴 초소형 AI로 LHC 데이터 실시간 필터링**
...
원문: https://theopenreader.org/Journalism:CERN_Uses_Tiny_AI_Models_Burned_into_Silicon_for_Real-Time_LHC_Data_Filtering

---

**에이전트에 집중하고 파일시스템은 잊어라**

Stanford JAI에서 AI 에이전트 중심 개발 철학을 다룬 글로, 파일시스템 조작보다 에이전트 기능 강화에 집중해야 한다는 주장을 담고 있습니다. 에이전트 기반 소프트웨어 설계의 새로운 관점을 제시합니다.

원문: https://jai.scs.stanford.edu/

---

## 💾 하드웨어

**AMD Ryzen 9 9950X3D2 Dual Edition — 208MB 캐시를 단일 칩에**
...
원문: https://arstechnica.com/gadgets/2026/03/amds-ryzen-9-9950x3d2-dual-edition-crams-208mb-of-cache-into-a-single-chip/

---

## 🛠 개발도구 / 오픈소스

**Velxio 2.0 — 브라우저에서 Arduino·ESP32·Raspberry Pi 에뮬레이션**

실제 하드웨어 없이 브라우저에서 바로 Arduino, ESP32, Raspberry Pi 3를 시뮬레이션할 수 있는 오픈소스 플랫폼 Velxio 2.0이 공개됐습니다. 임베디드 학습이나 프로토타이핑에 유용한 도구입니다.

원문: https://github.com/davidmonterocrespo24/velxio

---

**SCIP의 미래 — Sourcegraph의 코드 인텔리전스 계획**

Sourcegraph가 자사의 코드 인덱싱 프로토콜 SCIP(Stack-based Index Protocol)의 향후 발전 방향을 발표했습니다. 대규모 코드베이스 분석과 IDE 통합을 더 강화하는 방향으로 진화할 것으로 보입니다.

원문: https://sourcegraph.com/blog/the-future-of-scip

---

## 🔐 보안 / OS

**Redox OS, Namespace와 CWD를 Capability로 — 역할 기반 보안 강화**

Rust로 개발된 마이크로커널 OS Redox가 NLNet 지원 하에 Capability 기반 보안 모델을 도입했습니다. 네임스페이스와 현재 작업 디렉터리(CWD)를 권한 객체로 취급해 시스템 보안성을 높입니다.

원문: https://www.redox-os.org/news/nlnet-cap-nsmgr-cwd/
