---
title: "NuPhy Air75 V3 — 저프로파일 무선 메카니컬의 새 기준"
date: 2026-03-28
draft: false
tags: ["키보드", "기계식키보드", "NuPhy", "리뷰", "저프로파일", "무선키보드"]
categories: ["리서치"]
...
트래블 거리 3.5mm로 저프로파일 중 최장축. POM 스템으로 자체 윤활 효과와 내구성을 갖췄다.
...
**👍 장점**
- 저프로파일 최강 배터리 수명 (RGB 끄면 1,200시간)
...
> "저프로파일 무선 메카니컬 키보드 시장에서 현재 가장 완성도 높은 선택지."
